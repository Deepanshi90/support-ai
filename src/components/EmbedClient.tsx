        ...
        <div className='flex justify-center px-4 py-14'>
            ...
            >
                ...
                <div className='relative bg-zinc-900 text-zinc-100 rounded-xl p-5 text-sm font-mono mb-10'>
                    ...
                    <button
                        className={`absolute top-3 right-3  px-3 py-1.5 rounded text-xs ${copied ? "bg-green-500 text-white" : "bg-zinc-700 text-zinc-300 hover:bg-zinc-600"} cursor-pointer transition`}
                        onClick={copyCode}
                    >
                        {copied ? "Copied!" : "Copy"}
                    </button>
                ...
                <ol className='space-y-3 text-sm text-zinc-600 list-decimal list-inside'>
                    <li>
                        Copy the embeded Script.
                    </li>
                    <li>
                        Paste it before the closing <code>&lt;/body&gt;</code> tag on your website.
                    </li>
                    <li>
                        Once added, the chatbot will appear on your website, allowing visitors to interact with it and get support.
                    </li>
                </ol>
            ...
            <div className='rounded-xl border border-zinc-300 bg-white shadow-md overflow-hidden'>
                <div className='flex items-center gap-2 px-4 h-9 bg-zinc-100 border-b border-zinc-200'>
                    <span className='w-2 h-2.5 rounded-full bg-red-400'/>
                    <span className='w-2 h-2.5 rounded-full bg-yellow-400'/>
                    <span className='w-2 h-2.5 rounded-full bg-green-400'/>
                ...
                <div className='relative h-64 sm:h-72 p-6 text-zinc-400 text-sm'>
                    Your website goes here, and the chatbot will appear in the bottom right corner. Visitors can click on it to start a conversation and get support whenever they need it.
...
<div className='absolute bottom-24 right-6 w-64 bg-white rounded-xl shadow-xl border border-zinc-200 overflow-hidden'>
                    ...
                    <div className='p-3 space-y-2 bg-zinc-50'>
                        <div className='bg-zinc-200 text-zinc-800 text-xs px-3 py-2 rounded-2xl w-fit ml-auto'>Hi there! How can I help you today?</div>
                ...
                className='
                absolute bottom-6 right-6 w-14 h-14 rounded-full bg-black text-white flex items-center justify-center shadow-2xl cursor-pointer'
                >
                    💬
